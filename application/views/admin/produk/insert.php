    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"> Insert Produk Table</h4>
            </div>
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="jenis" class="form-control" placeholder="jenis" value="<?php echo set_value('jenis') ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="stok" class="form-control" placeholder="stok" value="<?php echo set_value('stok') ?>">
